...
namespace Deal.ViewModel
{
    ...
    {
        private RelayCommand <DetailItem> navigateCommand;
        ...
        public RelayCommand<DetailItem> NavigateCommand
        {
            get
            {
                return navigateCommand
                    ?? (navigateCommand = new RelayCommand<DetailItem>((data) => navigationService.NavigateTo(
